...
interface EmployeeRecordCertificateModalProps {
  open: boolean;
...
export const EmployeeRecordCertificateModal = ({ open, onOpenChange, member, onSave }: EmployeeRecordCertificateModalProps) => {
